            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('detailed_information'.tr(), style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w800, color: Colors.black87)),
                    const SizedBox(height: 16),
                    if (dept.isNotEmpty) _buildInfoRow(Icons.business_rounded, 'department_label'.tr(), dept),
                    if (position.isNotEmpty) _buildInfoRow(Icons.work_rounded, 'position_label'.tr(), position),
                    if (phone.isNotEmpty) _buildInfoRow(Icons.phone_rounded, 'phone_label'.tr(), phone),
                    if (email.isNotEmpty) _buildInfoRow(Icons.email_rounded, 'email_label'.tr(), email),
                    if (birthday.isNotEmpty) _buildInfoRow(Icons.cake_rounded, 'birthday'.tr(), birthday),
                    if (joinDate.isNotEmpty) _buildInfoRow(Icons.calendar_month_rounded, 'join_date'.tr(), joinDate),
                  ],
                ),
              ),
              const SizedBox(height: 20),
